import { AdditionalParameters, FeatureFlag, OptionalFlag, OrgAdditionalParams, RegisterAdditionalParameters, TokenResponse } from '../types/KindeSDK';
...
declare class KindeSDK extends runtime.BaseAPI {
    ...
    scope: string;
    additionalParameters: Pick<Partial<LoginMethodParams> | AdditionalParameters, 'audience'>;
     ...
     */
    constructor(issuer: string, redirectUri: string, clientId: string, logoutRedirectUri: string, scope?: string, additionalParameters?: Omit<Partial<LoginMethodParams> | AdditionalParameters, 'audience'>, authBrowserOptions?: AuthBrowserOptions);
    /**
     ...
     */
    login(additionalParameters?: Partial<LoginMethodParams> | AdditionalParameters, authBrowserOptions?: AuthBrowserOptions): Promise<TokenResponse | null>;
    /**
     ...
     */
    register(additionalParameters?: Partial<LoginMethodParams> | RegisterAdditionalParameters, authBrowserOptions?: AuthBrowserOptions): Promise<TokenResponse | null>;
    /**
     ...
     * @returns A promise that resolves to void.
     */
    createOrg(additionalParameters?: Omit<Partial<LoginMethodParams>, 'isCreateOrg'> | Omit<OrgAdditionalParams, 'is_create_org'>, authBrowserOptions?: AuthBrowserOptions): Promise<TokenResponse | null>;
    /**
