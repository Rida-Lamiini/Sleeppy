...
declare class AuthorizationCode {
     ...
     */
    authenticate(kindeSDK: KindeSDK, startPage: 'login' | 'registration' | 'none', additionalParameters: LoginMethodParams | AdditionalParameters, options?: AuthBrowserOptions): Promise<TokenResponse | null>;
}
